...
static DaoFuncItem dao__Funcs[] = 
{
  ...
  { dao__cblas_ddot, "cblas_ddot( n: int, x: array<float>, incx: int, y: array<float>, incy: int )=>float" },
  { dao__cblas_sasum, "cblas_sasum( n: int, x: array<float>, incx: int )=>float" },
  { dao__cblas_dasum, "cblas_dasum( n: int, x: array<float>, incx: int )=>float" },
  { dao__cblas_scasum, "cblas_scasum( n: int, x: array<float>, incx: int )=>float" },
  { dao__cblas_dzasum, "cblas_dzasum( n: int, x: array<float>, incx: int )=>float" },
  { dao__cblas_snrm2, "cblas_snrm2( N: int, X: array<float>, incX: int )=>float" },
  { dao__cblas_dnrm2, "cblas_dnrm2( N: int, X: array<float>, incX: int )=>float" },
  { dao__cblas_scnrm2, "cblas_scnrm2( N: int, X: array<float>, incX: int )=>float" },
  { dao__cblas_dznrm2, "cblas_dznrm2( N: int, X: array<float>, incX: int )=>float" },
  { dao__cblas_isamax, "cblas_isamax( n: int, x: array<float>, incx: int )=>int" },
  { dao__cblas_idamax, "cblas_idamax( n: int, x: array<float>, incx: int )=>int" },
  { dao__cblas_icamax, "cblas_icamax( n: int, x: array<float>, incx: int )=>int" },
  { dao__cblas_izamax, "cblas_izamax( n: int, x: array<float>, incx: int )=>int" },
  { dao__cblas_saxpy, "cblas_saxpy( n: int, alpha: float, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_daxpy, "cblas_daxpy( n: int, alpha: float, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_caxpy, "cblas_caxpy( n: int, alpha: array<float>, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_zaxpy, "cblas_zaxpy( n: int, alpha: array<float>, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_scopy, "cblas_scopy( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_dcopy, "cblas_dcopy( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_ccopy, "cblas_ccopy( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_zcopy, "cblas_zcopy( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_sswap, "cblas_sswap( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_dswap, "cblas_dswap( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_cswap, "cblas_cswap( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_zswap, "cblas_zswap( n: int, x: array<float>, incx: int, y: array<float>, incy: int )" },
  { dao__cblas_srot, "cblas_srot( N: int, X: array<float>, incX: int, Y: array<float>, incY: int, c: float, s: float )" },
  { dao__cblas_drot, "cblas_drot( N: int, X: array<float>, incX: int, Y: array<float>, incY: int, c: float, s: float )" },
  { dao__cblas_srotg, "cblas_srotg( a: float, b: array<float>, c: array<float>, s: array<float> )=>float" },
  { dao__cblas_drotg, "cblas_drotg( a: float, b: array<float>, c: array<float>, s: array<float> )=>float" },
  { dao__cblas_srotm, "cblas_srotm( N: int, X: array<float>, incX: int, Y: array<float>, incY: int, P: array<float> )" },
  { dao__cblas_drotm, "cblas_drotm( N: int, X: array<float>, incX: int, Y: array<float>, incY: int, P: array<float> )" },
  { dao__cblas_srotmg, "cblas_srotmg( d1: float, d2: array<float>, b1: array<float>, b2: float, P: array<float> )=>float" },
  { dao__cblas_drotmg, "cblas_drotmg( d1: float, d2: array<float>, b1: array<float>, b2: float, P: array<float> )=>float" },
  { dao__cblas_sscal, "cblas_sscal( N: int, alpha: float, X: array<float>, incX: int )" },
  { dao__cblas_dscal, "cblas_dscal( N: int, alpha: float, X: array<float>, incX: int )" },
  { dao__cblas_cscal, "cblas_cscal( N: int, alpha: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_zscal, "cblas_zscal( N: int, alpha: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_csscal, "cblas_csscal( N: int, alpha: float, X: array<float>, incX: int )" },
  { dao__cblas_zdscal, "cblas_zdscal( N: int, alpha: float, X: array<float>, incX: int )" },
  ...
  { dao__cblas_dgemv, "cblas_dgemv( order: int, trans: int, m: int, n: int, alpha: float, a: array<float>, lda: int, x: array<float>, incx: int, beta: float, y: array<float>, incy: int )" },
  ...
  { dao__cblas_zgemv, "cblas_zgemv( order: int, trans: int, m: int, n: int, alpha: array<float>, a: array<float>, lda: int, x: array<float>, incx: int, beta: array<float>, y: array<float>, incy: int )" },
  ...
  { dao__cblas_dger, "cblas_dger( order: int, M: int, N: int, alpha: float, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float>, lda: int )" },
  ...
  { dao__cblas_zgeru, "cblas_zgeru( order: int, M: int, N: int, alpha: array<float>, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float>, lda: int )" },
  { dao__cblas_zgerc, "cblas_zgerc( order: int, M: int, N: int, alpha: array<float>, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float>, lda: int )" },
  { dao__cblas_strsv, "cblas_strsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_dtrsv, "cblas_dtrsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_ctrsv, "cblas_ctrsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_ztrsv, "cblas_ztrsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_strmv, "cblas_strmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_dtrmv, "cblas_dtrmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_ctrmv, "cblas_ctrmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_ztrmv, "cblas_ztrmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_ssyr, "cblas_ssyr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float>, lda: int )" },
  { dao__cblas_dsyr, "cblas_dsyr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float>, lda: int )" },
  { dao__cblas_cher, "cblas_cher( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float>, lda: int )" },
  { dao__cblas_zher, "cblas_zher( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float>, lda: int )" },
  ...
  { dao__cblas_dsyr2, "cblas_dsyr2( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float>, lda: int )" },
  ...
  { dao__cblas_zher2, "cblas_zher2( order: int, Uplo: int, N: int, alpha: array<float>, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float>, lda: int )" },
  ...
  { dao__cblas_dgbmv, "cblas_dgbmv( order: int, TransA: int, M: int, N: int, KL: int, KU: int, alpha: float, A: array<float>, lda: int, X: array<float>, incX: int, beta: float, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_zgbmv, "cblas_zgbmv( order: int, TransA: int, M: int, N: int, KL: int, KU: int, alpha: array<float>, A: array<float>, lda: int, X: array<float>, incX: int, beta: array<float>, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_dsbmv, "cblas_dsbmv( order: int, Uplo: int, N: int, K: int, alpha: float, A: array<float>, lda: int, X: array<float>, incX: int, beta: float, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_dtbmv, "cblas_dtbmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, K: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  ...
  { dao__cblas_ztbmv, "cblas_ztbmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, K: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  ...
  { dao__cblas_dtbsv, "cblas_dtbsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, K: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  ...
  { dao__cblas_ztbsv, "cblas_ztbsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, K: int, A: array<float>, lda: int, X: array<float>, incX: int )" },
  { dao__cblas_stpmv, "cblas_stpmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_dtpmv, "cblas_dtpmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_ctpmv, "cblas_ctpmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_ztpmv, "cblas_ztpmv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_stpsv, "cblas_stpsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_dtpsv, "cblas_dtpsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_ctpsv, "cblas_ctpsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  { dao__cblas_ztpsv, "cblas_ztpsv( order: int, Uplo: int, TransA: int, Diag: int, N: int, Ap: array<float>, X: array<float>, incX: int )" },
  ...
  { dao__cblas_dsymv, "cblas_dsymv( order: int, Uplo: int, N: int, alpha: float, A: array<float>, lda: int, X: array<float>, incX: int, beta: float, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_zhemv, "cblas_zhemv( order: int, Uplo: int, N: int, alpha: array<float>, A: array<float>, lda: int, X: array<float>, incX: int, beta: array<float>, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_dspmv, "cblas_dspmv( order: int, Uplo: int, N: int, alpha: float, Ap: array<float>, X: array<float>, incX: int, beta: float, Y: array<float>, incY: int )" },
  { dao__cblas_sspr, "cblas_sspr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, Ap: array<float> )" },
  { dao__cblas_dspr, "cblas_dspr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, Ap: array<float> )" },
  { dao__cblas_chpr, "cblas_chpr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float> )" },
  { dao__cblas_zhpr, "cblas_zhpr( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, A: array<float> )" },
  ...
  { dao__cblas_dspr2, "cblas_dspr2( order: int, Uplo: int, N: int, alpha: float, X: array<float>, incX: int, Y: array<float>, incY: int, A: array<float> )" },
  ...
  { dao__cblas_zhpr2, "cblas_zhpr2( order: int, Uplo: int, N: int, alpha: array<float>, X: array<float>, incX: int, Y: array<float>, incY: int, Ap: array<float> )" },
  ...
  { dao__cblas_zhbmv, "cblas_zhbmv( order: int, Uplo: int, N: int, K: int, alpha: array<float>, A: array<float>, lda: int, X: array<float>, incX: int, beta: array<float>, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_zhpmv, "cblas_zhpmv( order: int, Uplo: int, N: int, alpha: array<float>, Ap: array<float>, X: array<float>, incX: int, beta: array<float>, Y: array<float>, incY: int )" },
  ...
  { dao__cblas_dgemm, "cblas_dgemm( Order: int, TransA: int, TransB: int, M: int, N: int, K: int, alpha: float, A: array<float>, lda: int, B: array<float>, ldb: int, beta: float, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_zgemm, "cblas_zgemm( Order: int, TransA: int, TransB: int, M: int, N: int, K: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int, beta: array<float>, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_dsymm, "cblas_dsymm( Order: int, Side: int, Uplo: int, M: int, N: int, alpha: float, A: array<float>, lda: int, B: array<float>, ldb: int, beta: float, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_zsymm, "cblas_zsymm( Order: int, Side: int, Uplo: int, M: int, N: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int, beta: array<float>, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_dsyrk, "cblas_dsyrk( Order: int, Uplo: int, Trans: int, N: int, K: int, alpha: float, A: array<float>, lda: int, beta: float, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_zsyrk, "cblas_zsyrk( Order: int, Uplo: int, Trans: int, N: int, K: int, alpha: array<float>, A: array<float>, lda: int, beta: array<float>, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_dsyr2k, "cblas_dsyr2k( Order: int, Uplo: int, Trans: int, N: int, K: int, alpha: float, A: array<float>, lda: int, B: array<float>, ldb: int, beta: float, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_zsyr2k, "cblas_zsyr2k( Order: int, Uplo: int, Trans: int, N: int, K: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int, beta: array<float>, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_dtrmm, "cblas_dtrmm( Order: int, Side: int, Uplo: int, TransA: int, Diag: int, M: int, N: int, alpha: float, A: array<float>, lda: int, B: array<float>, ldb: int )" },
  ...
  { dao__cblas_ztrmm, "cblas_ztrmm( Order: int, Side: int, Uplo: int, TransA: int, Diag: int, M: int, N: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int )" },
  ...
  { dao__cblas_dtrsm, "cblas_dtrsm( Order: int, Side: int, Uplo: int, TransA: int, Diag: int, M: int, N: int, alpha: float, A: array<float>, lda: int, B: array<float>, ldb: int )" },
  ...
  { dao__cblas_ztrsm, "cblas_ztrsm( Order: int, Side: int, Uplo: int, TransA: int, Diag: int, M: int, N: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int )" },
  ...
  { dao__cblas_zhemm, "cblas_zhemm( Order: int, Side: int, Uplo: int, M: int, N: int, alpha: array<float>, A: array<float>, lda: int, B: array<float>, ldb: int, beta: array<float>, C: array<float>, ldc: int )" },
  ...
  { dao__cblas_zherk, "cblas_zherk( Order: int, Uplo: int, Trans: int, N: int, K: int, alpha: float, A: array<float>, lda: int, beta: float, C: array<float>, ldc: int )" },
...
static void dao__cblas_sdsdot( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* y = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
...
static void dao__cblas_dsdot( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* y = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__cblas_ddot( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int incx = (const int) DaoValue_TryGetInteger( _p[2] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[4] );
  const double* y = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
...
static void dao__cblas_saxpy( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float alpha = (const float) DaoValue_TryGetFloat( _p[1] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[3] );
  float* y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[5] );
  const float* x = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
...
{
  const int n = (const int) DaoValue_TryGetInteger( _p[0] );
  const double alpha = (const double) DaoValue_TryGetFloat( _p[1] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[3] );
  double* y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[5] );
...
static void dao__cblas_scopy( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int n = (const int) DaoValue_TryGetInteger( _p[0] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[2] );
  float* y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[4] );
  const float* x = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
...
static void dao__cblas_dcopy( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int n = (const int) DaoValue_TryGetInteger( _p[0] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[2] );
  double* y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[4] );
  const double* x = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
...
{
  const int n = (const int) DaoValue_TryGetInteger( _p[0] );
  float* x = (float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[2] );
  float* y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[4] );
...
{
  const int n = (const int) DaoValue_TryGetInteger( _p[0] );
  double* x = (double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[2] );
  double* y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[4] );
...
static void dao__cblas_drot( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[4] );
  const double c = (const double) DaoValue_TryGetFloat( _p[5] );
  const double s = (const double) DaoValue_TryGetFloat( _p[6] );
...
static void dao__cblas_srotg( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* b = (float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
  float* c = (float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
  float* s = (float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__cblas_drotg( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* b = (double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
  double* c = (double*) DaoArray_ToFloat64( (DaoArray*)_p[2] );
  double* s = (double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
...
static void dao__cblas_srotm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[4] );
  const float* P = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[5] );
...
static void dao__cblas_drotm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[4] );
  const double* P = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[5] );
...
static void dao__cblas_srotmg( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* d2 = (float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
  float* b1 = (float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
  const float b2 = (const float) DaoValue_TryGetFloat( _p[3] );
  float* P = (float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
...
static void dao__cblas_drotmg( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* d2 = (double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
  double* b1 = (double*) DaoArray_ToFloat64( (DaoArray*)_p[2] );
  const double b2 = (const double) DaoValue_TryGetFloat( _p[3] );
  double* P = (double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
...
static void dao__cblas_sscal( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int N = (const int) DaoValue_TryGetInteger( _p[0] );
  const float alpha = (const float) DaoValue_TryGetFloat( _p[1] );
  float* X = (float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[3] );
...
static void dao__cblas_dscal( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int N = (const int) DaoValue_TryGetInteger( _p[0] );
  const double alpha = (const double) DaoValue_TryGetFloat( _p[1] );
  double* X = (double*) DaoArray_ToFloat64( (DaoArray*)_p[2] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[3] );
...
static void dao__cblas_sgemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[10] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[11] );
  const float* x = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[7] );
...
static void dao__cblas_dgemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[6] );
  const int incx = (const int) DaoValue_TryGetInteger( _p[8] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[9] );
  double* y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[10] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[11] );
  const double* x = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[7] );
...
static void dao__cblas_cgemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[10] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[11] );
  const float* beta = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
  const float* x = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[7] );
  const float* a = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[5] );
...
static void dao__cblas_zgemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[10] );
  const int incy = (const int) DaoValue_TryGetInteger( _p[11] );
  const double* beta = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const double* x = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[7] );
  const double* a = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[5] );
...
static void dao__cblas_sger( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* A = (float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const int lda = (const int) DaoValue_TryGetInteger( _p[9] );
  const float* Y = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
...
static void dao__cblas_dger( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[7] );
  double* A = (double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const int lda = (const int) DaoValue_TryGetInteger( _p[9] );
  const double* Y = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
...
static void dao__cblas_ssyr( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float alpha = (const float) DaoValue_TryGetFloat( _p[3] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  float* A = (float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
...
static void dao__cblas_dsyr( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const double alpha = (const double) DaoValue_TryGetFloat( _p[3] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  double* A = (double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
...
static void dao__cblas_sgbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[12] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[13] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
...
static void dao__cblas_dgbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int KL = (const int) DaoValue_TryGetInteger( _p[4] );
  const int KU = (const int) DaoValue_TryGetInteger( _p[5] );
  const double alpha = (const double) DaoValue_TryGetFloat( _p[6] );
  const int lda = (const int) DaoValue_TryGetInteger( _p[8] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[10] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[11] );
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[12] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[13] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
...
static void dao__cblas_cgbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[12] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[13] );
  const float* beta = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[11] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
  const float* A = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[7] );
...
static void dao__cblas_zgbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[12] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[13] );
  const double* beta = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[11] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[7] );
...
static void dao__cblas_stbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  float* X = (float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
...
static void dao__cblas_dtbmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int K = (const int) DaoValue_TryGetInteger( _p[5] );
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  double* X = (double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[9] );
...
static void dao__cblas_ssymv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[10] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
...
static void dao__cblas_dsymv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[5] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[7] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[8] );
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[10] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
...
static void dao__cblas_chemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[10] );
  const float* beta = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
  const float* A = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
  const float* alpha = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__cblas_zhemv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[10] );
  const double* beta = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
  const double* alpha = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
...
static void dao__cblas_sspmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[5] );
...
static void dao__cblas_dspmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const double alpha = (const double) DaoValue_TryGetFloat( _p[3] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[6] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[7] );
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[9] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[5] );
...
static void dao__cblas_sspr( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float alpha = (const float) DaoValue_TryGetFloat( _p[3] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  float* Ap = (float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
...
static void dao__cblas_dspr( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const double alpha = (const double) DaoValue_TryGetFloat( _p[3] );
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  double* Ap = (double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
...
static void dao__cblas_chpr2( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[7] );
  float* Ap = (float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const float* Y = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
  const float* alpha = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__cblas_zhpr2( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int incX = (const int) DaoValue_TryGetInteger( _p[5] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[7] );
  double* Ap = (double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const double* Y = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
  const double* alpha = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
...
static void dao__cblas_chpmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* Y = (float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[9] );
  const float* beta = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[7] );
  const float* X = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[5] );
  const float* Ap = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[4] );
  const float* alpha = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__cblas_zhpmv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* Y = (double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const int incY = (const int) DaoValue_TryGetInteger( _p[9] );
  const double* beta = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[7] );
  const double* X = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[5] );
  const double* Ap = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[4] );
  const double* alpha = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[3] );
...
static void dao__cblas_sgemm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float beta = (const float) DaoValue_TryGetFloat( _p[11] );
  float* C = (float*) DaoArray_ToFloat32( (DaoArray*)_p[12] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[13] );
  const float* B = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
  const float* A = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[7] );
...
static void dao__cblas_dgemm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int ldb = (const int) DaoValue_TryGetInteger( _p[10] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[11] );
  double* C = (double*) DaoArray_ToFloat64( (DaoArray*)_p[12] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[13] );
  const double* B = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[7] );
...
static void dao__cblas_ssymm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* C = (float*) DaoArray_ToFloat32( (DaoArray*)_p[11] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[12] );
  const float* B = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const float* A = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
...
static void dao__cblas_dsymm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  const int ldb = (const int) DaoValue_TryGetInteger( _p[9] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[10] );
  double* C = (double*) DaoArray_ToFloat64( (DaoArray*)_p[11] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[12] );
  const double* B = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
...
static void dao__cblas_csymm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  float* C = (float*) DaoArray_ToFloat32( (DaoArray*)_p[11] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[12] );
  const float* beta = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[10] );
  const float* B = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[8] );
  const float* A = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[6] );
...
static void dao__cblas_zsymm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double* C = (double*) DaoArray_ToFloat64( (DaoArray*)_p[11] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[12] );
  const double* beta = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[10] );
  const double* B = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[8] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
...
static void dao__cblas_ssyrk( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  const float beta = (const float) DaoValue_TryGetFloat( _p[8] );
  float* C = (float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
...
static void dao__cblas_dsyrk( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[7] );
  const double beta = (const double) DaoValue_TryGetFloat( _p[8] );
  double* C = (double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
  const int ldc = (const int) DaoValue_TryGetInteger( _p[10] );
  const double* A = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[6] );
...
static void dao__cblas_strmm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[9] );
  float* B = (float*) DaoArray_ToFloat32( (DaoArray*)_p[10] );
...
static void dao__cblas_dtrmm( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int lda = (const int) DaoValue_TryGetInteger( _p[9] );
  double* B = (double*) DaoArray_ToFloat64( (DaoArray*)_p[10] );
  const int ldb = (const int) DaoValue_TryGetInteger( _p[11] );
